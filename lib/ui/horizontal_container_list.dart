                  ...
                  itemBuilder: (context, index) {
                    return Row(
                      children: [
                        if (index == 0) ...[
                          SizedBox(
                              width: parentWidth * widget.marginWidthRatio - 16 ),
                        ],
                        Stack(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: LinearGradient(
                                  ...
                                  // Ends on the right
                                  stops: const [0.0, 1.0],
                                  // Optional: Defines the stops of each color
                                  tileMode: TileMode
                                      .clamp, // Ensures the gradient fills the entire area
                                ),
                              ),
                            ),
                            // Positioned(
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
          color: index == _selectedIndex
              ? Colors.black // widget.itemColor(index)   //TODO praveen
